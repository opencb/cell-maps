ListNumberAttributeGrid.prototype = new AttributeGrid();
...
ListNumberAttributeGrid.prototype._createNumberControlPanel = function (changeFunction) {
    var _this = this;
...
// NUMBER
ListNumberAttributeGrid.prototype._getUniqueValues = function () {
    ...
    for (var i = 0; i < values.length; i++) {
        ...
        for (var j = 0; j < valueSplit.length; j++) {
            ...
            if (typeof valuesMap[v] === 'undefined') {
                valuesMap[v] = true;
                valuesData.push({value: v, visualParam: this._normalizeFunction(v)});
            }
        }
    }
    return valuesData;
...
ListNumberAttributeGrid.prototype._createUniqueStore = function () {
...
ListNumberAttributeGrid.prototype._updateUniqueStore = function (modifiedAttributeName) {
...
ListNumberAttributeGrid.prototype._getUniqueMaxAndMin = function () {
    var values = this.attributeManager.getUniqueByAttribute(this.attributeName);
    var max = 0, min = 0;
